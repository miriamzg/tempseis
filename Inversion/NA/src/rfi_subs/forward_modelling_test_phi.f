...
c---------------------------------------------------------------------------------------
			...
			do j=1,nlines
				...
				do k=1,3
					do l=1,3
						...
						E_imag(j) = E_imag(j) + 0.5 * W(k,l) * dS_imag(k,l,j) 
					end do
				end do
				E_real(j) = 0.5 * E_real(j)
			...
			do j=1,nlines
				predicted_data_r(j,i) = point_source_real(j) + E_real(j)
				predicted_data_i(j,i) = point_source_imag(j) + E_imag(j)
