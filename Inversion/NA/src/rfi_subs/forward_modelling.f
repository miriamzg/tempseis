...
ca
	subroutine forward_modelling(
     ...
     &		dS1, dS2, point_source, freq_obs, nlines, output_final, initial_misfit)
c
...
c=============================
	...
	if (output_final) then
		write(111,*) "Spatial centroid module: ", rc_module, " angle: ", rc_angle
		write(111,*) "Temporal centroid: ",delta_t 
		write(111,*) "Duration: ", duration * sqrt(3.)
		write(111,*) "Velocity abs: ", vel_abs, " velocity angle: ", vel_angle
		write(111,*) "Amax: ", Amax * sqrt(3.), " Amin: ", Amin * sqrt(3.), " phi: ", phi
