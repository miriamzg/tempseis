...
def load_derivatives(station):
	...
	for der in derivative_list:
		filename = glob.glob("derivatives_mineos/"+station+"_Z_"+der+".txt")[0]
...
for station in station_list:
	...
	S2_predicted = S1_fft +   E  
 	...
 	predicted_trace.write("../../data/rfi_files/NA_SRF/"+predicted_trace.id+".sac.disp_S1", format="SAC")
