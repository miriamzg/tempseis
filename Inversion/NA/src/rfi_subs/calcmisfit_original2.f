...
c
	subroutine calcmisfit( predicted_data, observed_data, ndata,
     &       weight, nwaves, totmisfit, fname, amp_obs_real, amp_obs_imag, write_best )
c
c
...
c
	...
	real*4	 	a(15)
	real*4		m
	real*4		misfit_P_array(maxwave),misfit_S_array(maxwave),misfit_W_array(maxwave)
...
!	a = [1,5,2,1,40,2,5,2,7,1,5,100,100,100,100]
!	write(*,*) "a: ", a
!	call calc_median(a,m)
!	call median(a,10,0,m)
!	write(*,*) "median: ", m
!	stop
