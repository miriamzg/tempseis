...
event_code = "CMTSOLUTION_122200D_GCMT"
real = "yes"
...
out_folder 		= "../database/" + event_code + "/fortran_format_" + str(Tmin_p) + "_"  + str(Tmax_p) + "_"+ 			str(Tmin_s) + "_"+ str(Tmax_s) + "_"+ str(Tmin_r) + "_"+ str(Tmax_r) 
