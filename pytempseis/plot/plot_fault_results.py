...
rc_x = r0_x + rc_mod * np.sin((np.pi/2.) - rc_ang_r)
rc_y = r0_y + rc_mod * np.cos((np.pi/2.) - rc_ang_r)

#plotting

ell = mpl.patches.Ellipse(xy=[rc_x,rc_y], width=Amax_min, height=Amin_min, angle = phi, edgecolor='red', lw=2, facecolor='None', linestyle="--")
ell2 = mpl.patches.Ellipse(xy=[rc_x,rc_y], width=Amax_max, height=Amin_max, angle = phi, edgecolor='red', lw=2, facecolor='None', linestyle="--")
ell3 = mpl.patches.Ellipse(xy=[rc_x,rc_y], width=Amax, height=Amin, angle = phi, edgecolor='red', lw=2, facecolor='None', linestyle="-")
fig, ax = plt.subplots()
...
ax.arrow(rc_x,rc_y,vf[0], vf[1], head_width=2, head_length=2, linewidth=2, color="black", zorder=2)
ax.autoscale()
#plt.show()
